...
VAE_WEIGHTS_FILE = 'vae_weights.weights.h5'
DISCRIMINATOR_WEIGHTS_FILE = 'discriminator_weights.weights.h5'
...
class VAE(tf.keras.Model):
    def __init__(self, **kwargs):
        ...
        self.encoder = tf.keras.Sequential([
            ...
            layers.Dropout(0.2),
            layers.Conv2D(128, 3, strides=2, activation='leaky_relu', padding='same'),
            layers.BatchNormalization(),
            layers.Flatten(),
...
class VAEGAN(tf.keras.Model):
    def __init__(self, vae, discriminator, **kwargs):
        ...
        # Feature extractor из дискриминатора
...
if __name__ == "__main__":
    ...
    try:
        ...
        if x_test is not None:
            ...
            reconstructions = vae_gan.vae.predict(test_samples, verbose=0)
